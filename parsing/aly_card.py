...
TITLE_CLASS = "snow-ali-kit_Typography__base__1shggo"
PRICE_CLASS = "snow-price_SnowPrice__mainS__azqpin"
STATE_CLASS = "SnowSku_SkuPropertyItem__propNameWrap__sj6tl"
...
def find_elements(soup: BeautifulSoup):
    ...
    try:
        title = soup.find('h1', class_=TITLE_CLASS)
        # print(title.text)
        price = soup.find('div', class_=PRICE_CLASS)
        # print(price.text)
        from_state = soup.find('div', class_=STATE_CLASS)
